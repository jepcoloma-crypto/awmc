...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left: Brand Side */}
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-[#0b6e4f] to-[#2ec4b6] items-center justify-center overflow-hidden">
        {/* Decorative elements */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-40 -right-40 w-80 h-80 rounded-full bg-white/10 blur-3xl" />
          <div className="absolute -bottom-40 -left-40 w-96 h-96 rounded-full bg-[#2ec4b6]/15 blur-3xl" />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-gradient-to-br from-white/5 to-[#2ec4b6]/10 blur-2xl" />
          {/* Cross pattern */}
          <div className="absolute inset-0 opacity-[0.04]" style={{ backgroundImage: 'radial-gradient(circle at 1px 1px, white 1px, transparent 0)', backgroundSize: '40px 40px' }} />
        </div>

        <div className="relative z-10 text-center max-w-md px-12">
          <div className="w-16 h-16 rounded-2xl bg-white/15 backdrop-blur-sm flex items-center justify-center mx-auto mb-8 shadow-lg">
          ...
          <div className="mt-10 grid grid-cols-3 gap-4 text-center">
            {[
              ...
              <div key={s.label} className="rounded-xl bg-white/10 border border-white/20 px-3 py-4">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 bg-white dark:bg-gray-950">
        <div className="w-full max-w-sm">
          ...
          <div className="lg:hidden text-center mb-8">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#0b6e4f] to-[#2ec4b6] flex items-center justify-center mx-auto mb-4 shadow-lg shadow-[#0b6e4f]/20">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 focus:ring-2 focus:ring-[#0b6e4f]/20 focus:border-[#0b6e4f] outline-none transition-all text-sm"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 bg-gradient-to-r from-[#0b6e4f] to-[#2ec4b6] hover:from-[#085a3f] hover:to-[#1a936f] disabled:from-[#0b6e4f]/50 disabled:to-[#2ec4b6]/50 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-[#0b6e4f]/20 hover:shadow-xl hover:shadow-[#0b6e4f]/30 text-sm"
            >
              {loading ? (
